// pdfencrypt.js - Fixed encryption with pdf-lib-plus-encrypt fork
async function renderpdfencrypt(container) {
    try {
        await loadScript('https://cdn.jsdelivr.net/npm/pdf-lib-plus-encrypt@1.1.0/dist/pdf-lib.min.js');
